...
architecture behav of pointwise_conv_2d_cl_ap_fixed_ap_fixed_16_6_5_3_0_config9_s is 
    ...
    signal grp_fill_buffer_fu_121_ap_return : STD_LOGIC_VECTOR (15 downto 0);
    signal grp_fill_buffer_fu_121_ap_ce : STD_LOGIC;
...
begin
    grp_fill_buffer_fu_121 : component fill_buffer
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    grp_fill_buffer_fu_121_ap_ce_assign_proc : process(ap_CS_fsm_pp0_stage1, ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0_11001_ignoreCallOp20, ap_block_pp0_stage1_11001_ignoreCallOp24)
    begin
